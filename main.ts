...
let entrenadorTitular: Entrenador = new Entrenador("Sergio", "Alvarez", true);
let entrenadorSuplente: Entrenador = new Entrenador("Mateo", "Gonzalez", false);

let masajista1: Masajista = new Masajista("Juan", "Benitez", true);
...
let seleccionDeFutbol1: SeleccionDeFutbol = new SeleccionDeFutbol("Argentina", [masajista1, masajista2], [futbolista1, futbolista2], [entrenadorTitular, entrenadorSuplente]);
